...
COUCHBASE_BUCKET=$COUCHBASE_ADMINISTRATOR_USERNAME
#COUCHBASE_BUCKET_PASSWORD=$COUCHBASE_ADMINISTRATOR_PASSWORD
...
curl -v -u $COUCHBASE_ADMINISTRATOR_USERNAME:$COUCHBASE_ADMINISTRATOR_PASSWORD -X POST http://127.0.0.1:8091/pools/default/buckets -d name=$COUCHBASE_BUCKET -d bucketType=couchbase -d ramQuotaMB=128 -d authType=sasl
